  ...
  useEffect(() => {
    const loadDashboardData = async () => {
      try {
        ...
        setStats({
          submitted: st.totalReports ?? fetchedReports.length,
          pending: st.pendingReports ?? fetchedReports.filter((r) => r.status === 'Pending').length,
          verified: st.verifiedReports ?? fetchedReports.filter((r) => r.status === 'Verified').length,
